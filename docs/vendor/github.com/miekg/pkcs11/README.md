...
- [type Ctx](<#type-ctx>)
  ...
  - [func (c *Ctx) GetAttributeValue(sh SessionHandle, o ObjectHandle, a []*Attribute) ([]*Attribute, error)](<#func-ctx-getattributevalue>)
...
- [type MechanismInfo](<#type-mechanisminfo>)
