...
### func \(\*MutatingWebhookConfiguration\) APILifecycleDeprecated
...
### func \(\*MutatingWebhookConfigurationList\) APILifecycleDeprecated
...
### func \(\*ValidatingWebhookConfigurationList\) APILifecycleDeprecated
